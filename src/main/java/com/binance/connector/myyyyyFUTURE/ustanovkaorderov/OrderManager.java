...
public class OrderManager {
    ...
    public Order createMarketOrder(String symbol, String side, double quantity) { //"origType":"MARKET"//todo квенти был стриннгом - если будут неполадки сомтреть сюда
        ...
        return ParserOrderov.parseOrder(response); //цену входа стаовим в процессоре  в zahodVShellPoziciyu
...
//    Market Order Response: {"orderId":945383596,"symbol":"ACHUSDT","status":"NEW","clientOrderId":"XWE2lEN9zwGvMtrWlBMD1F","price":"0.0000000","avgPrice":"0.00","origQty":"307","executedQty":"0","cumQty":"0","cumQuote":"0.0000000","timeInForce":"GTC","type":"MARKET","reduceOnly":false,"closePosition":false,"side":"SELL","positionSide":"BOTH","stopPrice":"0.0000000","workingType":"CONTRACT_PRICE","priceProtect":false,"origType":"MARKET","priceMatch":"NONE","selfTradePreventionMode":"NONE","goodTillDate":0,"updateTime":1704332660235}
    ...
    public void setMARKETTakeProfitForShort(String symbol, String quantity, String stopPrice) {
        ...
        public Order creatLIMITOrderTakeProfit(String symbol, double quantity, double price) {//"origType":"LIMIT"
...
//    Delayed Buy Order Response: {"orderId":945443217,"symbol":"ACHUSDT","status":"NEW","clientOrderId":"hTlLnebo8vkZCQDCYBxiLK","price":"0.0220000","avgPrice":"0.00","origQty":"308","executedQty":"0","cumQty":"0","cumQuote":"0.0000000","timeInForce":"GTC","type":"LIMIT","reduceOnly":false,"closePosition":false,"side":"BUY","positionSide":"BOTH","stopPrice":"0.0000000","workingType":"CONTRACT_PRICE","priceProtect":false,"origType":"LIMIT","priceMatch":"NONE","selfTradePreventionMode":"NONE","goodTillDate":0,"updateTime":1704334994981}


//0.01950


    public Order creatLIMITOrderStopLoss(String symbol, double quantity, double price) {//"origType":"STOP_MARKET"
